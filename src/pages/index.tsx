  ...
  const UserMenu = () => {
    ...
    return (
      <Menu>
        ...
        <Menu.Items className="absolute flex flex-col mt-32 shadow-md rounded right-96">
          <button>
...
const HabitModal: React.FC = () => {
  ...
  const {mutate: habit} = api.habit.createHabit.useMutation();
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      onClick={() => {setIsOpen(false); createHabit()}}
                    >
                      Create
                    </button>
                  </div>
